...
async def should_search_web(prompt: str) -> bool:
    ...
    - Real-time external information (e.g., "what's the weather in Hanoi?")
...
async def generate_search_query(prompt: str) -> str:
    ...
    system_prompt = f"""
    {time_}.
    Rewrite the user's question into a concise, effective English search query for recent news and company information.
